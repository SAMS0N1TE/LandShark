...
/* Embedded extension: provide the output buffer externally (e.g. in PSRAM).
 * Must be called once before SAMMain(). Buffer must be sized for the longest
 * expected utterance (22050 samples/sec × seconds × 1 byte). */
